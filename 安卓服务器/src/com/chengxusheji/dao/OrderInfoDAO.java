...
public class OrderInfoDAO {
    ...
    public ArrayList<OrderInfo> QueryOrderInfoInfo(String orderNo,Movie movieObj,UserInfo userObj,String orderTime,String receiveName,String telephone,OrderState orderStateObj,int currentPage) { 
    	Session s = factory.getCurrentSession();
    	String hql = "From OrderInfo orderInfo where 1=1";
    	if(!orderNo.equals("")) hql = hql + " and orderInfo.orderNo like '%" + orderNo + "%'";
    	if(null != movieObj && movieObj.getMovieId()!=0) hql += " and orderInfo.movieObj.movieId=" + movieObj.getMovieId();
    	...
    	if(null != orderStateObj && orderStateObj.getOrderStateId()!=0) hql += " and orderInfo.orderStateObj.orderStateId=" + orderStateObj.getOrderStateId();
    ...
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public ArrayList<OrderInfo> QueryOrderInfoInfo(String orderNo,Movie movieObj,UserInfo userObj,String orderTime,String receiveName,String telephone,OrderState orderStateObj) { 
    	Session s = factory.getCurrentSession();
    	String hql = "From OrderInfo orderInfo where 1=1";
    	if(!orderNo.equals("")) hql = hql + " and orderInfo.orderNo like '%" + orderNo + "%'";
    	if(null != movieObj && movieObj.getMovieId()!=0) hql += " and orderInfo.movieObj.movieId=" + movieObj.getMovieId();
    ...
    /*计算总的页数和记录数*/
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public void CalculateTotalPageAndRecordNumber(String orderNo,Movie movieObj,UserInfo userObj,String orderTime,String receiveName,String telephone,OrderState orderStateObj) {
        Session s = factory.getCurrentSession();
        String hql = "From OrderInfo orderInfo where 1=1";
        if(!orderNo.equals("")) hql = hql + " and orderInfo.orderNo like '%" + orderNo + "%'";
        if(null != movieObj && movieObj.getMovieId()!=0) hql += " and orderInfo.movieObj.movieId=" + movieObj.getMovieId();
