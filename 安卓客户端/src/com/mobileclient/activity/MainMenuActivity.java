...
public class MainMenuActivity extends Activity {
    ...
    public class ImageAdapter extends BaseAdapter {
        ...
        private String[] menuString = {"用户管理","电影类型管理","电影管理","地区管理","订单管理","订单状态管理"};
        ...
        public View getView(int position, View convertView, ViewGroup parent) { 
			...
			iv.setImageResource(mThumbIds[position]); 
			  switch (position) {
				...
				case 1:
					// 电影类型管理监听器
					view.setOnClickListener(movieTypeLinstener);
					break;
				case 2:
					// 电影管理监听器
					view.setOnClickListener(movieLinstener);
					break;
				case 3:
					// 地区管理监听器
    ...
    OnClickListener movieTypeLinstener = new OnClickListener() {
		public void onClick(View v) {
			Intent intent = new Intent();
			// 启动电影类型管理Activity
			intent.setClass(MainMenuActivity.this, MovieTypeListActivity.class);
			startActivity(intent);
		}
	};
    OnClickListener movieLinstener = new OnClickListener() {
		public void onClick(View v) {
			Intent intent = new Intent();
			// 启动电影管理Activity
			intent.setClass(MainMenuActivity.this, MovieListActivity.class);
			startActivity(intent);
		}
	};
