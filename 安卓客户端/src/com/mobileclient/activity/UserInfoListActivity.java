				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new UserInfoSimpleAdapter(UserInfoListActivity.this, list,
	        					...
	        					new String[] { "user_name","name","gender","birthDate","userPhoto","telephone" },
	        					new int[] { R.id.tv_user_name,R.id.tv_name,R.id.tv_gender,R.id.tv_birthDate,R.id.iv_userPhoto,R.id.tv_telephone,},lv);
